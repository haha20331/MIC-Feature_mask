...
_base_ = [
    ...
    '../_base_/datasets/med_semi_supervised_RedDataset.py',
...
data = dict(
    train=dict(
        ...
        rare_class_sampling=dict(
            ...
            min_pixels=3000, class_temp=0.5, min_crop_ratio=2.0),
...
name = '50:50_ALLData_tua=0.6_mask_ratio=090_womix'
exp = 'basic'
name_dataset = 'Med_semisupervised'
