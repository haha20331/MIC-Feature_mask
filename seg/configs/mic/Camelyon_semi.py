...
_base_ = [
    ...
    '../_base_/models/camelyon_daformer_sepaspp_mitb5.py',
    # GTA->Cityscapes High-Resolution Data Loading
    '../_base_/datasets/1_2_camelyon_use5img.py',
    # DAFormer Self-Training
    '../_base_/uda/camelyon_dacs_a999_fdthings.py',
    # AdamW Optimizer
    '../_base_/schedules/adamw.py',
    # Linear Learning Rate Warmup with Subsequent Linear Decay
    '../_base_/schedules/city_poly10warm.py'
]
# Random Seed
...
name = 'camelyon_1_2_use5img_fmask=070_SC'
#name = 'test'
exp = 'basic'
